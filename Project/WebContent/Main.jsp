    ...
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
            <img src="/image1/11/Little_Forest_(리틀_포레스트).jpg" alt="#" onclick="location.href='/page/Page.do?boardName=3'">
        ...
        <div class="swiper-slide"><img src="/images/mid.jpg.crdownload" alt="#"">
            ...
            <div class="swiper-slide"><img src="/images/grand_buda.jpg" alt="#" onclick="location.href='/page/Page.do?boardName=0'">
                <i class="fa fa-star" aria-hidden="true"></i><span>4.5</span><a class="txt"> /5</a> 
                <p class="movietext1">The Grand Budapest Hotel (2014)</p>
            </div>
                <div class="swiper-slide"><img src="/images/1/es.png" alt="#" onclick="location.href='/page/Page.do?boardName=1'">
...
<div class="swiper-button-prev"></div><!-- 이전 버튼 -->
  ...
  <div class="movies">
    ...
    <div class="swiper-container">
    <div class="swiper-wrapper">
        <div class="swiper-slide"><img src="/image1/12/The_Wailing_(film).png" alt="#" onclick="location.href='/page/Page.do?boardName=2'">
