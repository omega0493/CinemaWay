...
<!-- 구글검색 --> 
              ...
              <ul class="navbar-nav mr-auto">
                  <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdown01">
                          <li><a class="dropdown-item" href="/page/Page.do?boardName=0">추천영화</a></li>
                          <li><div class="dropdown-divider"></div></li>
                          <li><a class="dropdown-item" href="/page/Page.do?boardName=1">계절별영화</a></li>
                          <li><div class="dropdown-divider"></div></li>
                          <li><a class="dropdown-item" href="/page/Page.do?boardName=2">분위기별영화</a></li>
                      </ul>
                  </li>
                  <li class="nav-item dropdown">
                  ...
                  <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdown01">
                          <li><a class="dropdown-item" href="../project/reviewlist.do">리뷰게시판</a></li>
                          <li><div class="dropdown-divider"></div></li>
                          <li><a class="dropdown-item" href="../project/threadlist.do">자유게시판</a></li>
                          <li><div class="dropdown-divider"></div></li>
                          <li><a class="dropdown-item" href="../customerservice/qna1.do">고객센터</a></li>
                      </ul>
                  </li>
              </ul>
          </div>
	...
	<form method=get action="http://www.google.co.kr/search" target="_blank" display="hidden">
            <!-- 검색창 -->
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
				...
				<div><a class="nav-item p-3" style="cursor: pointer;" onclick="location.href='/mypage.do'"> ${User.name } 님</a></div>
